...
website = 'http://news.buaa.edu.cn/'
url = 'http://news.buaa.edu.cn/'
file_dir=r'C:\Users\18810\PycharmProjects\work_7'
...
if rp.can_fetch(useragent, url):
    ...
    page_url = 'http://news.buaa.edu.cn/'

    # 提取形如 href="http://news.sina.com.cn/o/2018-11-06/doc-ihmutuea7351575.shtml" 的字符串
    ulist = re.findall('href="[a-z0-9/.\-]+\.htm', content)
    i = 1
    for u in ulist:
        u = u[6:]
        u = parse.urljoin(page_url, u)
        print(u)
